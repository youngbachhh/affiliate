...
const totalUnreadNotifications = computed(
  () => props.notifications.filter((item) => !item.isSeen).length
);
</script>
    ...
    >
      <VCard class="d-flex flex-column">
        ...
        <VCardItem class="notification-section">
          <h5 class="text-h5 text-truncate">Thông báo</h5>
        ...
        <VCardText v-show="props.notifications.length" class="pa-4">
          <VBtn block size="small"> Xem tất cả thông báo </VBtn>
        </VCardText>
      </VCard>
    </VMenu>
  </IconBtn>
