...
<template>
  <IconBtn>
    ...
    <VMenu activator="parent" offset="15px" location="bottom end">
      <VCard max-width="380" max-height="560" class="d-flex flex-column">
        <VCardItem class="px-4 py-2">
          <h5 class="text-h5">Lối tắt</h5>

          <template #append>
            <IconBtn>
              <VIcon icon="ri-add-line" color="high-emphasis" />
          ...
          <VRow class="ma-0 mt-n1">
            ...
            >
              <VAvatar variant="tonal" size="50">
                <VIcon color="high-emphasis" size="26" :icon="shortcut.icon" />
              </VAvatar>
