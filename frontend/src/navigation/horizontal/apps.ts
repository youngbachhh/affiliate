export default [
  {
    ...
    //       { title: 'Xem trước', to: { name: 'apps-invoice-preview-id', params: { id: '5036' } } },
    ...
    //       { title: 'Chi tiết', to: { name: 'apps-user-view-id', params: { id: 21 } } },
    //     ],
    //   },
    //   {
  ...
  {
    title: "Product",
    icon: { icon: "ri-square-3-stack-3d" },
    children: [
      { title: "List", to: "apps-ecommerce-product-list" },
      { title: "Add", to: "apps-ecommerce-product-add" },
      { title: "Category", to: "apps-ecommerce-product-category-list" },
