        ...
        <VCardText>
          <VRow>
            <VCol cols="12" sm="6">
              <div :class="$vuetify.display.smAndUp ? 'border-e' : 'border-b'">
                <div class="d-flex align-center gap-x-2">
                  <h4 class="text-h3 text-primary">4.89</h4>
                  <VIcon icon="ri-star-smile-line" color="primary" size="32" />
                </div>
                <h6 class="my-2 text-h6">Total 187 reviews</h6>
                <div class="mb-2">All reviews are from genuine customers</div>
                <VChip
                  color="primary"
                  size="small"
            ...
            <VCol cols="12" sm="6">
              ...
              >
                <div class="text-sm text-no-wrap">{{ item.rating }} Star</div>
                <div class="w-100">
                  <VProgressLinear
                    color="primary"
                    height="8"
            ...
            <VCol cols="12" sm="5">
              <div>
                ...
                <div class="mb-9">
                  ...
                  <VChip color="success" size="small"> +8.4% </VChip>
                </div>
      ...
      <VCard>
        <VCardText>
          <div class="d-flex justify-space-between flex-wrap gap-y-4">
            ...
            <div class="d-flex flex-row gap-4 align-center flex-wrap">
              ...
              />
              <VBtn prepend-icon="ri-upload-2-line"> Export </VBtn>
            </div>
          </div>
        </VCardText>
        ...
        >
          <template #item.product="{ item }">
            <div class="d-flex gap-x-4 align-center">
              ...
              <div class="d-flex flex-column">
                ...
                <span class="text-sm text-wrap clamp-text">{{
                  item.companyName
                }}</span>
              </div>
            </div>
          ...
          <template #item.review="{ item }">
            <div class="py-4">
              <VRating :size="24" readonly :model-value="item.review" />
            ...
            <div class="d-flex justify-end flex-wrap gap-x-6 px-2 py-1">
              ...
              <div class="d-flex gap-x-2 align-center me-2">
                ...
                <VBtn
                  ...
                  @click="
                    page >= Math.ceil(totalReviews / itemsPerPage)
                      ? (page = Math.ceil(totalReviews / itemsPerPage))
                      : page++
                  "
                />
