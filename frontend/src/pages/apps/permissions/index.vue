...
<template>
  <VCard>
    <VCardText
      class="d-flex align-center justify-sm-space-between justify-start gap-4 flex-wrap"
    >
      <VTextField
        v-model="search"
        density="compact"
      ...
      <VBtn density="default" @click="isAddPermissionDialogVisible = true">
        Add Permission
      </VBtn>
    </VCardText>
    ...
    >
      ...
      <template #item.actions="{ item }">
        <IconBtn size="small" @click="editPermission(item.name)">
        ...
        <div class="d-flex justify-end flex-wrap gap-x-6 px-2 py-1">
          ...
          <div class="d-flex gap-x-2 align-center me-2">
            ...
            <VBtn
              ...
              @click="
                page >= Math.ceil(totalPermissions / itemsPerPage)
                  ? (page = Math.ceil(totalPermissions / itemsPerPage))
                  : page++
              "
            />
