  ...
  <VRow no-gutters class="auth-wrapper">
    ...
    >
      <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-4">
        <VCardText>
          <h4 class="text-h4 mb-1">Bắt đầu mua sắm 🚀</h4>
          <p class="mb-0">Quản lý việc mua sắm, đội nhóm dễ dàng!</p>
        </VCardText>
            ...
            <VRow>
              ...
              <VCol cols="12">
                ...
                <div class="d-flex align-center my-5">
                  ...
                  <VLabel for="privacy-policy" style="opacity: 1">
                    <span class="me-1 text-high-emphasis">Tôi đồng ý với</span>
              ...
              <VCol cols="12">
                <div class="text-center text-base">
                  <span class="d-inline-block"> Đã có tài khoản? </span>
                  <RouterLink
