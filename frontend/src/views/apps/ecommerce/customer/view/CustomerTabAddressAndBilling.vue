...
<template>
  ...
  <VCard class="mb-6">
    <VCardText>
      <div
        class="d-flex justify-space-between mb-5 flex-wrap align-center gap-y-4 gap-x-6"
      >
        <h5 class="text-h5">Địa chỉ giao hàng</h5>
        <VBtn
          variant="outlined"
          size="small"
          @click="
      ...
      <template v-for="(address, index) in addressData" :key="index">
        <div
          class="d-flex justify-space-between mb-3 gap-y-2 flex-wrap align-center"
        >
          <div class="d-flex align-center gap-x-2">
            <IconBtn density="comfortable" @click="show[index] = !show[index]">
              <VIcon
                :icon="
                  show[index] ? 'ri-arrow-down-s-line' : 'ri-arrow-right-s-line'
                "
          ...
          <div class="ms-11">
            <IconBtn @click="isEditAddressDialogVisible = true">
              <VIcon icon="ri-edit-box-line" class="flip-in-rtl" />
            </IconBtn>
            <IconBtn>
              <VIcon icon="ri-delete-bin-7-line" class="flip-in-rtl" />
            </IconBtn>
            <IconBtn>
              <VIcon icon="ri-more-2-fill" class="flip-in-rtl" />
            </IconBtn>
          </div>
        </div>
        <VExpandTransition>
          <div v-show="show[index]" class="ps-12">
        ...
        <VDivider v-if="index !== addressData.length - 1" class="my-3" />
      </template>
    </VCardText>
  </VCard>
  ...
  <VCard>
    <VCardText>
      <div
        class="d-flex justify-space-between mb-5 flex-wrap align-center gap-y-4 gap-x-6"
      >
        <h5 class="text-h5">Phương thức thanh toán</h5>
        <VBtn
          variant="outlined"
          size="small"
      ...
      <template v-for="(payment, index) in paymentData" :key="index">
        <div
          class="d-flex justify-space-between mb-4 gap-y-2 flex-wrap align-center"
        >
          <div class="d-flex align-center gap-2">
            ...
            <VImg :src="payment.image" height="30" width="50" class="me-4" />
        ...
        <VExpandTransition>
          <div v-show="paymentShow[index]" class="ps-12">
            <VRow>
              <VCol cols="12" md="6">
                <VTable>
                  <tr>
                    <td class="text-sm pb-1" style="inline-size: 100px">Tên</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      Violet Mendoza
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Số</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      **** 4487
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Expires</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      08/2028
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Type</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      Master Card
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Issuer</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      VICBANK
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">ID</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      DH73DJ8
                    </td>
                  </tr>
              ...
              <VCol cols="12" md="6">
                <VTable>
                  <tr>
                    <td class="text-sm pb-1" style="inline-size: 100px">
                      Billing
                    </td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      United Kingdom
                  ...
                  <tr>
                    <td class="text-sm pb-1">Number</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      +7634 983 637
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Email</td>
                    <td class="text-sm text-high-emphasis font-weight-medium">
                      vafgot@vultukir.org
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">Origin</td>
                    <td class="d-flex">
                      <div
                        class="text-body-2 font-weight-medium text-high-emphasis me-2"
                      >
                        United States
                      </div>
                      <img :src="usFlag" height="20" width="20" />
                    </td>
                  </tr>
                  <tr>
                    <td class="text-sm pb-1">CVC</td>
                    <td class="d-flex">
                      <div
                        class="text-body-2 font-weight-medium text-high-emphasis me-2"
                      >
                      ...
                      <VAvatar variant="tonal" color="success" size="20" inline>
                        <VIcon icon="ri-check-line" color="success" size="12" />
                      </VAvatar>
                    </td>
                  </tr>
                </VTable>
        ...
        <VDivider v-if="index !== paymentData.length - 1" class="my-4" />
      </template>
    </VCardText>
  </VCard>
  ...
  />
  <AddEditAddressDialog
    v-model:isDialogVisible="isNewEditAddressDialogVisible"
  />
  <CardAddEditDialog
