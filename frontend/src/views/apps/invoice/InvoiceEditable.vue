  ...
  <VCard class="pa-12">
    ...
    >
      ...
      <div>
        <!-- 👉 Invoice Id -->
        <div
          class="d-flex align-start font-weight-medium justify-sm-end flex-column flex-sm-row text-lg mb-3"
        >
          <span class="text-high-emphasis me-4" style="inline-size: 5.625rem"
            >Hóa đơn:</span
          >
          <span>
            <VTextField
        ...
        <!-- 👉 Issue Date -->
        <div
          class="d-flex align-start justify-sm-end flex-column flex-sm-row mb-3"
        >
          <span class="text-high-emphasis me-4" style="inline-size: 5.625rem"
            >Ngày phát hành:</span
          >
        ...
        <!-- 👉 Due Date -->
        <div
          class="d-flex align-start justify-sm-end flex-column flex-sm-row mb-0"
        >
          <span class="text-high-emphasis me-4" style="inline-size: 5.625rem"
            >Ngày hết hạn:</span
          >
    ...
    <VRow>
      ...
      <VCol class="text-no-wrap">
        ...
        <table>
          <tbody>
            <tr>
              <td class="pe-6">Ngày đến hạn:</td>
              <td>{{ props.data.paymentDetails.totalDue }}</td>
            </tr>
            <tr>
              <td class="pe-6">Tên ngân hàng:</td>
    ...
    <div class="add-products-form">
      ...
      <VBtn size="small" prepend-icon="ri-add-line" @click="addItem">
        Thêm sản phẩm
      </VBtn>
    </div>
    ...
    <div class="d-flex justify-space-between flex-wrap flex-column flex-sm-row">
      <div class="mb-6 mb-sm-0">
        ...
        <VTextField v-model="thanksNote" placeholder="Cảm ơn bạn" />
      </div>
          ...
          <tbody>
            <tr>
              ...
              <td :class="$vuetify.locale.isRtl ? 'text-start' : 'text-end'">
                <h6 class="text-h6">$1800</h6>
              </td>
            </tr>
            <tr>
              <td class="pe-16">Giảm giá:</td>
              <td :class="$vuetify.locale.isRtl ? 'text-start' : 'text-end'">
                <h6 class="text-h6">$28</h6>
              </td>
            </tr>
            <tr>
    ...
    <div>
      <h6 class="text-h6 mb-2">Ghi chú:</h6>
      <VTextarea v-model="note" placeholder="Viết ghi chú ở đây..." :rows="2" />
    </div>
  </VCard>
</template>
