    ...
    <VSheet class="footer-top pt-15" theme="dark">
      <VContainer>
        <VRow>
          ...
          <VCol cols="12" lg="5">
            <div class="mb-4 footer-form">
              <div class="d-flex align-center gap-x-3 mb-6">
                ...
                <div class="footer-title">MATERIO</div>
              </div>
          ...
          <VCol>
            <div
              class="d-flex justify-space-between flex-grow-1 gap-x-16 gap-y-8 flex-md-row flex-column"
            >
              <div>
                <div class="footer-heading mb-6">Pages</div>
                <ul style="list-style: none">
                  <li v-for="(item, index) in menus" :key="index" class="mb-4">
                    <RouterLink class="footer-text text-no-wrap" :to="item.to">
              ...
              <!-- 👉 Products  -->
              <div>
                <div class="footer-heading mb-6">Products</div>
                <ul>
                  <li
                    v-for="(item, index) in [
                      'Page Builder',
                  ...
                  >
                    <RouterLink to="" class="footer-text text-no-wrap">
                      {{ item }}
                    </RouterLink>
                  </li>
                </ul>
              ...
              <!-- 👉 Download App -->
              <div>
                <div class="footer-heading mb-6">Download our app</div>
                <div>
                  <VBtn
                    v-for="(item, index) in [
                    ...
                    <template #default>
                      <div class="d-flex gap-x-3">
                        ...
                        <div>
                          ...
                          <div
                            class="text-body-2 font-weight-medium text-white"
                          >
                            {{ item.store }}
                          </div>
                        </div>
