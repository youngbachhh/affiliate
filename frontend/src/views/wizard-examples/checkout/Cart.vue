...
<template>
  <VRow v-if="checkoutCartDataLocal">
    <VCol cols="12" md="8">
      <!-- 👉 Offers alert -->
      <!-- <VAlert color="success" variant="tonal" icon="ri-percent-line" closable>
        <VAlertTitle class="text-success mb-1"> Available Offers </VAlertTitle>
        ...
        <p class="mb-0">
          - 50% Cashback Voucher of up to $60 on first ever PayPal transaction.
          TCA
        </p>
      </VAlert> -->

      <h5 class="text-h5 my-4">
        Giỏ hàng của tôi ({{ checkoutCartDataLocal.cartItems.length }} sản phẩm)
      </h5>

      <!-- 👉 Cart items -->
      <div v-if="checkoutCartDataLocal.cartItems.length" class="border rounded">
        <template
        ...
        >
          ...
          >
            ...
            >
              <VIcon size="18" icon="ri-close-line" />
            </IconBtn>
            ...
            >
              <div>
                ...
                <div class="my-2">
                  <VRating :model-value="item.rating" size="24" />
                </div>
    ...
    <VCol cols="12" md="4">
      <VCard flat variant="outlined">
        <!-- 👉 payment offer -->
        <VCardText>
          <h6 class="text-h6 mb-4">Chi tiết</h6>
          ...
          <div class="d-flex align-center gap-4">
            ...
            <VBtn variant="outlined" @click="updateCartData"> Áp dụng </VBtn>
          </div>

          <!-- 👉 Gift wrap banner -->
          <!-- <div class="bg-var-theme-background rounded pa-5 mt-4">
            <h6 class="text-h6">Buying gift for a loved one?</h6>
        ...
        <VCardText>
          ...
          <div class="text-sm text-high-emphasis">
            <div class="d-flex justify-space-between mb-2">
              <div class="text-body-1 text-high-emphasis">Tổng sản phẩm</div>
              <div class="text-body-1">${{ totalCost }}.00</div>
            </div>

            <div class="d-flex justify-space-between mb-2">
              <div class="text-body-1 text-high-emphasis">Mã giảm giá</div>
              <a href="javascript:void(0)" class="text-base d-inline-block"
                >Áp mã giảm giá</a
              >
            </div>
            ...
            <div class="d-flex justify-space-between">
              <div class="text-body-1 text-high-emphasis">Phí vận chuyển</div>

              <div class="d-flex gap-x-2">
                <div
                  class="text-decoration-line-through text-body-1 text-disabled"
                >
                  $5.00
                </div>
